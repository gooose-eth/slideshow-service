          ...
          createBaseVNode("header", _hoisted_1$7, [
            ...
            createBaseVNode("nav", null, [
              createBaseVNode("button", {
                ...
                createVNode(_sfc_main$9, { "icon-name": "x" })
              ], 8, _hoisted_2$7)
            ])
          ]),
          ...
          return openBlock(), createElementBlock("li", {
            ...
            createBaseVNode("div", _hoisted_3$5, [
              createBaseVNode("i", null, [
                createVNode(_sfc_main$9, { "icon-name": "menu-flat" })
              ])
            ]),
            ...
            createBaseVNode("nav", _hoisted_8$5, [
              createBaseVNode("button", {
                ...
                createVNode(_sfc_main$9, { "icon-name": "edit" })
              ], 8, _hoisted_9$5),
              createBaseVNode("button", {
                type: "button",
        ...
        createBaseVNode("fieldset", null, [
          ...
          createBaseVNode("div", _hoisted_2$5, [
            createBaseVNode("div", _hoisted_3$4, [
              createBaseVNode("h3", _hoisted_4$4, [
                createBaseVNode("label", _hoisted_5$4, toDisplayString(unref(t)("base.groupKey")), 1)
              ]),
              createBaseVNode("p", _hoisted_6$4, toDisplayString(unref(t)("description.inputKeyOnGroup")), 1),
            ...
            createBaseVNode("div", _hoisted_8$4, [
              createBaseVNode("h3", _hoisted_9$4, [
                createBaseVNode("label", _hoisted_10$3, toDisplayString(unref(t)("base.name")), 1)
              ]),
              createBaseVNode("p", _hoisted_11$2, toDisplayString(unref(t)("description.setCategoryName")), 1),
          ...
          createBaseVNode("div", _hoisted_13$2, [
            createBaseVNode("h3", _hoisted_14$2, [
              createBaseVNode("label", _hoisted_15$2, toDisplayString(unref(t)("base.description")), 1)
            ]),
            createBaseVNode("p", _hoisted_16$1, toDisplayString(unref(t)("description.setCategoryDescription")), 1),
          ...
          createBaseVNode("div", _hoisted_18$1, [
            createBaseVNode("h3", _hoisted_19$1, [
              createBaseVNode("label", _hoisted_20$1, toDisplayString(unref(t)("title.selectSlidesType")), 1)
            ]),
            createBaseVNode("p", _hoisted_21$1, toDisplayString(unref(t)("description.selectSlidesType")) + " " + toDisplayString(__props.form.type === "edit" ? unref(t)("description.selectSlidesType2") : ""), 1),
          ...
          unref(state).form.slidesType === "url" ? (openBlock(), createElementBlock("div", _hoisted_23$1, [
            createBaseVNode("h3", _hoisted_24$1, [
              createBaseVNode("label", _hoisted_25$1, toDisplayString(unref(t)("title.slidesUrlAddress")), 1)
            ]),
            createBaseVNode("p", _hoisted_26, toDisplayString(unref(t)("description.inputSlidesUrl")), 1),
          ...
          createBaseVNode("nav", _hoisted_28, [
        ...
        createBaseVNode("fieldset", null, [
          ...
          createBaseVNode("div", _hoisted_2$4, [
            createBaseVNode("div", _hoisted_3$3, [
              createBaseVNode("h3", _hoisted_4$3, [
                createBaseVNode("label", _hoisted_5$3, toDisplayString(unref(t)("base.imageUrl")), 1)
              ]),
              createBaseVNode("p", _hoisted_6$3, toDisplayString(unref(t)("description.inputImageUrl")), 1),
            ...
            createBaseVNode("div", _hoisted_9$3, [
              createBaseVNode("h3", _hoisted_10$2, [
                createBaseVNode("label", _hoisted_11$1, toDisplayString(unref(t)("base.urlThumbnailUrl")), 1)
              ]),
              createBaseVNode("p", _hoisted_12$1, toDisplayString(unref(t)("description.inputThumbnailUrl")), 1),
            ...
            createBaseVNode("div", _hoisted_15$1, [
              createBaseVNode("h3", _hoisted_16, [
                createBaseVNode("label", _hoisted_17, toDisplayString(unref(t)("base.subject")), 1)
              ]),
              createBaseVNode("p", _hoisted_18, toDisplayString(unref(t)("description.inputSlideTitle")), 1),
            ...
            createBaseVNode("div", _hoisted_20, [
              createBaseVNode("h3", _hoisted_21, [
                createBaseVNode("label", _hoisted_22, toDisplayString(unref(t)("base.description")), 1)
              ]),
              createBaseVNode("p", _hoisted_23, toDisplayString(unref(t)("description.inputDescriptionSlide")), 1),
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("article", _hoisted_1$3, [
            ...
            createBaseVNode("header", _hoisted_3$2, [
              ...
              createBaseVNode("h3", null, [
                createBaseVNode("strong", null, [
                  createBaseVNode("b", null, toDisplayString(item.key), 1),
              ...
              createBaseVNode("nav", null, [
                item.fold ? (openBlock(), createElementBlock("button", {
                  ...
                  createVNode(_sfc_main$9, { "icon-name": "plus" })
        ...
        createBaseVNode("nav", _hoisted_10$1, [
          createVNode(ButtonBasic, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("label", {
        ...
        createBaseVNode("span", _hoisted_2$2, [
          createVNode(_sfc_main$9, { "icon-name": "file" }),
          createBaseVNode("em", null, toDisplayString(unref(state).filename || __props.label), 1),
          createBaseVNode("i", null, [
            createVNode(_sfc_main$9, { "icon-name": "upload" })
          ])
        ])
      ], 2);
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("form", {
        ...
        createBaseVNode("fieldset", null, [
          ...
          createBaseVNode("div", _hoisted_2$1, [
            ...
            unref(state).mode === "address" ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
              createBaseVNode("h3", _hoisted_6$1, [
                createBaseVNode("label", _hoisted_7$1, toDisplayString(unref(t)("title.importDataByAddress")), 1)
              ]),
            ...
            unref(state).mode === "file" ? (openBlock(), createElementBlock("div", _hoisted_10, [
              createBaseVNode("h3", _hoisted_11, [
                createBaseVNode("label", _hoisted_12, toDisplayString(unref(t)("title.importDataByFile")), 1)
              ]),
          ...
          createBaseVNode("nav", _hoisted_15, [
            createBaseVNode("div", null, [
              createVNode(ButtonBasic, {
                type: "submit",
      ...
      return openBlock(), createElementBlock("fieldset", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_3, [
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("h3", _hoisted_5, toDisplayString(unref(t)("title.manageSlideData")), 1),
