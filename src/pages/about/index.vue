...
<article class="about">
  ...
  <figure>
    <picture>
      <source srcset="./images/slideshow-screen-001.webp 1x, ./images/slideshow-screen-001@2x.webp 2x" type="image/webp">
      <source srcset="./images/slideshow-screen-001.png 1x, ./images/slideshow-screen-001@2x.png 2x" type="image/png">
      <img src="./images/slideshow-screen-001.png" alt="slideshow screen">
    </picture>
  </figure>
  <p>
  ...
  <figure>
    <picture>
      <source srcset="./images/slideshow-screen-002.webp 1x, ./images/slideshow-screen-002@2x.webp 2x" type="image/webp">
      <source srcset="./images/slideshow-screen-002.png 1x, ./images/slideshow-screen-002@2x.png 2x" type="image/png">
      <img src="./images/slideshow-screen-002.png" alt="screen">
    </picture>
  </figure>
  <p>
  ...
  <figure>
    <picture>
      <source srcset="./images/slideshow-screen-003.webp 1x, ./images/slideshow-screen-003@2x.webp 2x" type="image/webp">
      <source srcset="./images/slideshow-screen-003.png 1x, ./images/slideshow-screen-003@2x.png 2x" type="image/png">
      <img src="./images/slideshow-screen-003.png" alt="screen">
    </picture>
  </figure>
  <p>
  ...
  <figure>
    <picture>
      <source srcset="./images/slideshow-screen-004.webp 1x, ./images/slideshow-screen-004@2x.webp 2x" type="image/webp">
      <source srcset="./images/slideshow-screen-004.png 1x, ./images/slideshow-screen-004@2x.png 2x" type="image/png">
      <img src="./images/slideshow-screen-004.png" alt="screen">
    </picture>
  </figure>
  <p>
  ...
  <figure>
    <picture>
      <source srcset="./images/slideshow-screen-005.webp 1x, ./images/slideshow-screen-005@2x.webp 2x" type="image/webp">
      <source srcset="./images/slideshow-screen-005.png 1x, ./images/slideshow-screen-005@2x.png 2x" type="image/png">
      <img src="./images/slideshow-screen-005.png" alt="screen">
    </picture>
  </figure>
  <p>
